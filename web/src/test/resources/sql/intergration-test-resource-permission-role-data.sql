...
insert into `sys_resource`(`id`, `parent_id`, `parent_ids`, weight, `name`, `identity`, `url`, `is_show`)
        values (1, 0, '0/', 1, '示例列表', 'example:example', '/is_showcase/sample', true);
insert into `sys_resource`(`id`, `parent_id`, `parent_ids`, weight, `name`, `identity`, `url`, `is_show`)
        values (2, 0, '0/', 2, '逻辑删除列表', 'example:deleted', '/is_showcase/deleted', false);
insert into `sys_resource`(`id`, `parent_id`, `parent_ids`, weight, `name`, `identity`, `url`, `is_show`)
        values (3, 0, '0/', 4, '文件上传列表', 'example:upload', '/is_showcase/upload', true);
